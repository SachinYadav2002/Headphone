...
const Controll = () => {
  return (
    <div className="md:max-w-[85%] max-w-[95%] flex justify-center py-10 mx-auto p-2 bg-gradient-65 from-yellow-300 to-pink-500 transform h-screen   ">
      <div className="items-center justify-center sm:flex">
        ...
        <div>
          <div className="flex items-center justify-center text-center relative overflow-hidden min-h-[70vh] sm:min-h-screen 2xl:sm:min-h-[70vh]">
            ...
            <img
              className="absolute left-0 right-0 ml-auto mr-auto w-[400px] xl:w-[600px]"
              src={img}
            ></img>
          </div>
        </div>
